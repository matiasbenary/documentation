...
You can read more about our consensus strategy on our [Validator Quickstart](https://github.com/near/wiki/blob/master/Archive/validators/about) and [Staking FAQ](https://github.com/near/wiki/blob/master/Archive/validators/faq).
</Tip>

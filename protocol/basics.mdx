...
1. Use [**named accounts**](./account-model) like `alice.near`
2. Simple sign-up: create an [account for free](../tutorials/protocol/create-account), login [with socials](../web3-apps/tutorials/wallet-login) or [telegram](https://web.telegram.org/k/#@herewalletbot)
...
5. [Access Keys](./access-keys) make it safe and easy to use

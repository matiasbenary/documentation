...
Check out our tutorial on [Creating a NEAR Account](../tutorials/protocol/create-account) to get started!
</Tip>
...
### [Multiple Keys](access-keys)
NEAR accounts can have multiple [keys](access-keys), each with their own set of permissions:

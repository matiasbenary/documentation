...
- Derive macros for [NEP standards](./standard)
  - [NEP-141](https://github.com/near/NEPs/blob/master/neps/nep-0141) (fungible token), extension [NEP-148](https://github.com/near/NEPs/blob/master/neps/nep-0148)
  - [NEP-145](https://github.com/near/NEPs/blob/master/neps/nep-0145) (storage management), and integrations for the fungible token and non-fungible token standards
  - [NEP-171](https://github.com/near/NEPs/blob/master/neps/nep-0171) (non-fungible token), extensions [NEP-177](https://github.com/near/NEPs/blob/master/neps/nep-0177), [NEP-178](https://github.com/near/NEPs/blob/master/neps/nep-0178), [NEP-181](https://github.com/near/NEPs/blob/master/neps/nep-0181)
  - [NEP-297](https://github.com/near/NEPs/blob/master/neps/nep-0297) (events)

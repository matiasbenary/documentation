...
Here is an example from our [auctions tutorial](../../tutorials/auction/3.2-ft) where we implement `ft_on_transfer` to handle bids in FTs:
...
1. [NEP-141 standard](https://github.com/near/NEPs/tree/master/neps/nep-0141)
2. [NEP-148 standard](https://github.com/near/NEPs/tree/master/neps/nep-0148)
3. [FT Event Standards](https://github.com/near/NEPs/blob/master/neps/nep-0300)
4. [FT reference implementation](https://github.com/near-examples/FT)
5. [Fungible Tokens 101](../../tutorials/fts) - a set of tutorials that cover how to create a FT contract using Rust.